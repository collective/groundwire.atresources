...
def setup_product():
    ...
    import groundwire.atresources
    zcml.load_config('configure.zcml', groundwire.atresources)
    ...
    ztc.installPackage('groundwire.atresources')
...
setup_product()
ptc.setupPloneSite(products=['groundwire.atresources'])
